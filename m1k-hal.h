...
#define M1K_HAL_ERRCHK(statement)                                                                  \
    {                                                                                              \
        m1k_hal_err_t __err_ = statement;                                                          \
...
#define M1K_HAL_ACCESSORY_BUS_DISPLAY_NAME_LEN 40

struct m1k_hal_accessory_bus_device {
    char display_name[M1K_HAL_ACCESSORY_BUS_DISPLAY_NAME_LEN];
    uint8_t address;
};

typedef struct m1k_hal_accessory_bus_device m1k_hal_accessory_bus_device_t;

typedef void (*m1k_hal_accessory_scan_callback_t)(m1k_hal_accessory_bus_device_t*, void*);
...
//=== Fault Management
typedef void (*m1k_hal_fault_handler_t)(void);
